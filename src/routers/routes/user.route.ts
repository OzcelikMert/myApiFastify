...
export const userRoute = function (fastify: FastifyInstance, opts: any, done: () => void) {
    ...
    fastify.put(userEndPoint.UPDATE_PROFILE_IMAGE, { preHandler: [RequestMiddleware.check(UserSchema.putProfileImage), SessionAuthMiddleware.check] }, UserController.updateProfileImage);
