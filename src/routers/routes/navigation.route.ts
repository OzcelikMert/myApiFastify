...
export default function (fastify: FastifyInstance, opts: any, done: () => void) {
    ...
    fastify.put(navigationEndPoint.UPDATE_RANK_WITH_ID, { preHandler: [requestMiddleware.check(navigationSchema.putRank), sessionMiddleware.check, permissionMiddleware.check(navigationPermission.update), navigationMiddleware.check] }, navigationController.updateOneRank);
    ...
    fastify.put(navigationEndPoint.UPDATE_WITH_ID, { preHandler: [requestMiddleware.check(navigationSchema.put), sessionMiddleware.check, permissionMiddleware.check(navigationPermission.update), navigationMiddleware.check] }, navigationController.updateOne);
