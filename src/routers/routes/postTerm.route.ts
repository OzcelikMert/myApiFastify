...
export default function (fastify: FastifyInstance, opts: any, done: () => void) {
    ...
    fastify.put(postTermEndPoint.UPDATE_RANK_WITH_ID, { preHandler: [requestMiddleware.check(postTermSchema.putOneRank), sessionMiddleware.check, permissionMiddleware.check(permissionUtil.getPostPermission), postTermMiddleware.checkOne] }, postTermController.updateOneRank);
    ...
    fastify.put(postTermEndPoint.UPDATE_WITH_ID, { preHandler: [requestMiddleware.check(postTermSchema.putOne), sessionMiddleware.check, permissionMiddleware.check(permissionUtil.getPostPermission), postTermMiddleware.checkOne] }, postTermController.updateOne);
